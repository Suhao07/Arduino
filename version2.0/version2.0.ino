...
const unsigned long interval = 100;  // 定时执行任务的时间间隔（1秒）
const unsigned long last_interval=3000;//每次舵机转动定时三秒
const unsigned long targetInterval2 = 100;  // 目标定时中断的时间间隔（毫秒）
volatile bool weightflag = false;  // 食槽的重量
const unsigned long timing_interval = 10000; // 6小时的间隔，以毫秒为单位*以10秒作演示
